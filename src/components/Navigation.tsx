    ...
    <nav className="absolute top-0 inset-x-0 z-50 w-full bg-dark-teal/90 backdrop-blur-md border-b border-medium-teal/30">
      <div className="flex items-center justify-between px-6 md:px-10 py-5 w-full">
        ...
        <div className="flex items-center gap-6 shrink-0">
          ...
          <button className="bg-pathway-blue text-white px-7 py-2.5 rounded-[25px] text-sm font-bold tracking-wide hover:bg-pathway-blue/80 shadow-[0_0_15px_rgba(0,158,217,0.3)] hover:shadow-[0_0_20px_rgba(0,158,217,0.5)] transition-all">
            Apply
          </button>
